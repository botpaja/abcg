...
void Window::onPaint() {
  ...
  m_pneu1 = m_modelMatrix;
  m_pneu1 = glm::translate(m_pneu1, glm::vec3(0.0f, 0.0f, -0.5f));
  m_pneu1 = glm::rotate(m_pneu1, glm::radians(90.0f), glm::vec3(0, 1, 0));
  m_pneu1 = glm::scale(m_pneu1, glm::vec3(0.2f));

  abcg::glUniformMatrix4fv(modelMatrixLoc, 1, GL_FALSE, &m_pneu1[0][0]);
  abcg::glUniform4f(colorLoc, 1.0f, 1.0f, 1.0f, 1.0f); // White
  m_model.render(m_trianglesToDraw);

  //DRAW YELLOW BUNNY
  m_pneu1 = m_modelMatrix;
  m_pneu1 = glm::translate( m_pneu1, glm::vec3(-0.5f, 0.0f, 0.0f));
  m_pneu1 = glm::rotate( m_pneu1, glm::radians(90.0f), glm::vec3(0, 1, 0));
  m_pneu1 = glm::scale( m_pneu1, glm::vec3(0.2f));
